...
class PutSalesEstimatesSalesEstimate(object):
    openapi_types = {
        "contact_id": "str",
        "date": "date",
        "expiry_date": "date",
        ...
        "estimate_lines": "list[PutSalesEstimatesSalesEstimateEstimateLines]",
    ...
    def __eq__(self, other):
        if not isinstance(other, PutSalesEstimatesSalesEstimate):
            return False
