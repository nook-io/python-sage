...
class AllocatedArtefactPush(object):
    """
    Attributes:
    ...
    openapi_types = {"id": "str", "artefact_id": "Generic", "amount": "float"}
    attribute_map = {"id": "id", "artefact_id": "artefact_id", "amount": "amount"}

    def __init__(
        self, id=None, artefact_id=None, amount=None, local_vars_configuration=None
    ):
