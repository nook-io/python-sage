...
import sage
from sage.models.put_bank_accounts import PutBankAccounts  # noqa: E501
from sage.rest import ApiException

class TestPutBankAccounts(unittest.TestCase):
    """PutBankAccounts unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PutBankAccounts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = sage.models.put_bank_accounts.PutBankAccounts()  # noqa: E501
        if include_optional :
            return PutBankAccounts(
                bank_account = sage.models.put_bank_accounts_bank_account.putBankAccounts_bank_account(
