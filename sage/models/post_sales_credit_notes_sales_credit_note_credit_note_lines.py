...
class PostSalesCreditNotesSalesCreditNoteCreditNoteLines(object):
    """
    Attributes:
    ...
    def unit_price(self, unit_price):
        if self.local_vars_configuration.client_side_validation and unit_price is None:
    ...
    def __eq__(self, other):
        if not isinstance(other, PostSalesCreditNotesSalesCreditNoteCreditNoteLines):
            return False
