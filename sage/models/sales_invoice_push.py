...
class SalesInvoicePush(object):
    ...
    openapi_types = {
        ...
        "contact_id": "str",
        "recurring_invoice": "RecurringSalesInvoice",
        ...
        "sent_by_email": "bool",
        "void_reason": "str",
        "invoice_lines": "list[SalesInvoiceLineItem]",
        ...
        "last_paid": "date",
        "original_quote_estimate": "SalesInvoiceQuoteEstimate",
        ...
        "corrections": "list[SalesCorrectiveInvoice]",
        "tax_reconciled": "bool",
        "migrated": "bool",
    }
    attribute_map = {
    ...
    def __init__(
        ...
        self._original_quote_estimate = None
        ...
        if original_quote_estimate is not None:
            self.original_quote_estimate = original_quote_estimate
    ...
    def invoice_number_prefix(self, invoice_number_prefix):
        if (
            ...
            and invoice_number_prefix is not None
            and len(invoice_number_prefix) > 6
        ):
            raise ValueError(
                "Invalid value for `invoice_number_prefix`, length must be less than or equal to `6`"
            )
    ...
    def terms_and_conditions(self, terms_and_conditions):
        if (
            ...
            and len(terms_and_conditions) > 2000
        ):
            raise ValueError(
                "Invalid value for `terms_and_conditions`, length must be less than or equal to `2000`"
            )
    ...
    @property
    def original_quote_estimate(self):
        return self._original_quote_estimate

    @original_quote_estimate.setter
    def original_quote_estimate(self, original_quote_estimate):
        self._original_quote_estimate = original_quote_estimate
    ...
    def delivery_performance_date(self, delivery_performance_date):
        if (
            self.local_vars_configuration.client_side_validation
            and delivery_performance_date is not None
            and len(delivery_performance_date) > 40
        ):
            raise ValueError(
                "Invalid value for `delivery_performance_date`, length must be less than or equal to `40`"
            )
