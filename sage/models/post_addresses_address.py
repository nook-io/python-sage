...
class PostAddressesAddress(object):
    openapi_types = {
        "address_type_id": "str",
        "name": "str",
    ...
    def address_type_id(self, address_type_id):
        if (
            ...
            and address_type_id is None
        ):
            raise ValueError("Invalid value for `address_type_id`, must not be `None`")
    ...
    def is_main_address(self, is_main_address):
        if (
            self.local_vars_configuration.client_side_validation
            and is_main_address is None
        ):
            raise ValueError("Invalid value for `is_main_address`, must not be `None`")
    ...
    def __eq__(self, other):
        if not isinstance(other, PostAddressesAddress):
            return False
