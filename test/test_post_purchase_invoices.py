...
import sage
from sage.models.post_purchase_invoices import PostPurchaseInvoices  # noqa: E501
from sage.rest import ApiException

class TestPostPurchaseInvoices(unittest.TestCase):
    """PostPurchaseInvoices unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PostPurchaseInvoices
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = sage.models.post_purchase_invoices.PostPurchaseInvoices()  # noqa: E501
        if include_optional :
            return PostPurchaseInvoices(
                purchase_invoice = sage.models.post_purchase_invoices_purchase_invoice.postPurchaseInvoices_purchase_invoice(
                    contact_id = '0', 
                    ...
                    invoice_lines = [
                        sage.models.post_purchase_invoices_purchase_invoice_invoice_lines.postPurchaseInvoices_purchase_invoice_invoice_lines(
                            description = '0', 
                            ledger_account_id = '0', 
                            quantity = 1.337, 
                            unit_price = 1.337, 
    ...
    def testPostPurchaseInvoices(self):
        """Test PostPurchaseInvoices"""
