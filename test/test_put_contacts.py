...
import sage
from sage.models.put_contacts import PutContacts  # noqa: E501
from sage.rest import ApiException

class TestPutContacts(unittest.TestCase):
    """PutContacts unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = sage.models.put_contacts.PutContacts()  # noqa: E501
        if include_optional :
            return PutContacts(
                contact = sage.models.put_contacts_contact.putContacts_contact(
                    name = '0', 
                    contact_type_ids = [
                        '0'
                        ], 
