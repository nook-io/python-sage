...
import sage
from sage.models.put_sales_invoices import PutSalesInvoices  # noqa: E501
from sage.rest import ApiException

class TestPutSalesInvoices(unittest.TestCase):
    """PutSalesInvoices unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PutSalesInvoices
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = sage.models.put_sales_invoices.PutSalesInvoices()  # noqa: E501
        if include_optional :
            return PutSalesInvoices(
                sales_invoice = sage.models.put_sales_invoices_sales_invoice.putSalesInvoices_sales_invoice(
                    contact_id = '0', 
