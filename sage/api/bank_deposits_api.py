...
class BankDepositsApi(object):
    ...
    def delete_bank_deposits_key(self, key, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete_bank_deposits_key(key, async_req=True)
        >>> result = thread.get()
        ...
        return self.delete_bank_deposits_key_with_http_info(key, **kwargs)  # noqa: E501

    def delete_bank_deposits_key_with_http_info(self, key, **kwargs):  # noqa: E501
        """Deletes a Bank Deposit  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('key' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `key` when calling `delete_bank_deposits_key`")  # noqa: E501
    ...
    def get_bank_deposits(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bank_deposits(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_bank_deposits_with_http_info(**kwargs)  # noqa: E501
    ...
    def get_bank_deposits_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'items_per_page' in local_var_params and local_var_params['items_per_page'] > 200:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `items_per_page` when calling `get_bank_deposits`, must be a value less than or equal to `200`")  # noqa: E501
        if self.api_client.client_side_validation and 'items_per_page' in local_var_params and local_var_params['items_per_page'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `items_per_page` when calling `get_bank_deposits`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[BankDeposit]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_bank_deposits_key(self, key, **kwargs):  # noqa: E501
        """Returns a Bank Deposit  # noqa: E501

        ### Endpoint Availability  * Accounting Plus: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Standard: 🇬🇧, 🇮🇪 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Bank`: Read Only, Restricted Access, Full Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_bank_deposits_key(key, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_bank_deposits_key_with_http_info(key, **kwargs)  # noqa: E501

    def get_bank_deposits_key_with_http_info(self, key, **kwargs):  # noqa: E501
        """Returns a Bank Deposit  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('key' not in local_var_params or  # noqa: E501
                                                        local_var_params['key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `key` when calling `get_bank_deposits_key`")  # noqa: E501
    ...
    def post_bank_deposits(self, bank_deposits, **kwargs):  # noqa: E501
        """Creates a Bank Deposit  # noqa: E501

        ### Endpoint Availability  * Accounting Plus: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Standard: 🇬🇧, 🇮🇪 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Bank`: Full Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_bank_deposits(bank_deposits, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param PostBankDeposits bank_deposits: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_bank_deposits_with_http_info(bank_deposits, **kwargs)  # noqa: E501

    def post_bank_deposits_with_http_info(self, bank_deposits, **kwargs):  # noqa: E501
        """Creates a Bank Deposit  # noqa: E501

        ### Endpoint Availability  * Accounting Plus: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸 * Accounting Standard: 🇬🇧, 🇮🇪 * Accounting Start: 🇨🇦, 🇩🇪, 🇪🇸, 🇫🇷, 🇬🇧, 🇮🇪, 🇺🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area `Bank`: Full Access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_bank_deposits_with_http_info(bank_deposits, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'bank_deposits' is set
        if self.api_client.client_side_validation and ('bank_deposits' not in local_var_params or  # noqa: E501
                                                        local_var_params['bank_deposits'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `bank_deposits` when calling `post_bank_deposits`")  # noqa: E501
