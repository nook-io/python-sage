...
import sage
from sage.models.put_sales_estimates_sales_estimate import PutSalesEstimatesSalesEstimate  # noqa: E501
from sage.rest import ApiException

class TestPutSalesEstimatesSalesEstimate(unittest.TestCase):
    """PutSalesEstimatesSalesEstimate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PutSalesEstimatesSalesEstimate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = sage.models.put_sales_estimates_sales_estimate.PutSalesEstimatesSalesEstimate()  # noqa: E501
        if include_optional :
            return PutSalesEstimatesSalesEstimate(
                contact_id = '0', 
                ...
                delivery_address = sage.models.post_sales_corrective_invoices_sales_corrective_invoice_main_address.postSalesCorrectiveInvoices_sales_corrective_invoice_main_address(
                    ...
                    country_group_id = '0', ), 
                estimate_lines = [
                    sage.models.put_sales_estimates_sales_estimate_estimate_lines.putSalesEstimates_sales_estimate_estimate_lines(
                        description = '0', 
                        ledger_account_id = '0', 
                        quantity = 1.337, 
                        unit_price = 1.337, 
    ...
    def testPutSalesEstimatesSalesEstimate(self):
        """Test PutSalesEstimatesSalesEstimate"""
