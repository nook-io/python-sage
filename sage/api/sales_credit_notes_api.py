...
class SalesCreditNotesApi(object):
    def __init__(self, api_client=None):
        if api_client is None:
            api_client = ApiClient()
        self.api_client = api_client

    def delete_sales_credit_notes_key(self, key, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.delete_sales_credit_notes_key_with_http_info(key, **kwargs)

    def delete_sales_credit_notes_key_with_http_info(self, key, **kwargs):
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method delete_sales_credit_notes_key" % key
                )
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `delete_sales_credit_notes_key`"
            )
        collection_formats = {}
        path_params = {}
    ...
    def get_sales_credit_notes(self, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_sales_credit_notes_with_http_info(**kwargs)

    def get_sales_credit_notes_with_http_info(self, **kwargs):
        local_var_params = locals()
        all_params = [
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_sales_credit_notes" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        if (
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_sales_credit_notes`, must be a value less than or equal to `200`"
            )
        if (
            self.api_client.client_side_validation
            and "items_per_page" in local_var_params
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_sales_credit_notes`, must be a value greater than or equal to `1`"
            )
        collection_formats = {}
        path_params = {}
        query_params = []
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="list[SalesCreditNote]",
            auth_settings=auth_settings,
            async_req=local_var_params.get("async_req"),
            _return_http_data_only=local_var_params.get("_return_http_data_only"),
            _preload_content=local_var_params.get("_preload_content", True),
    ...
    def get_sales_credit_notes_key(self, key, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_sales_credit_notes_key_with_http_info(key, **kwargs)

    def get_sales_credit_notes_key_with_http_info(self, key, **kwargs):
        local_var_params = locals()
        all_params = [
            "key",
            "show_payments_allocations",
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_sales_credit_notes_key" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `get_sales_credit_notes_key`"
            )
        collection_formats = {}
        path_params = {}
        if "key" in local_var_params:
    ...
    def post_sales_credit_notes(self, sales_credit_notes, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.post_sales_credit_notes_with_http_info(sales_credit_notes, **kwargs)

    def post_sales_credit_notes_with_http_info(self, sales_credit_notes, **kwargs):
        local_var_params = locals()
        all_params = ["sales_credit_notes"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_sales_credit_notes" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        if self.api_client.client_side_validation and (
            "sales_credit_notes" not in local_var_params
            or local_var_params["sales_credit_notes"] is None
        ):
            raise ApiValueError(
                "Missing the required parameter `sales_credit_notes` when calling `post_sales_credit_notes`"
            )
        collection_formats = {}
        path_params = {}
        query_params = []
    ...
    def post_sales_credit_notes_key_release(self, key, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.post_sales_credit_notes_key_release_with_http_info(key, **kwargs)

    def post_sales_credit_notes_key_release_with_http_info(self, key, **kwargs):
        local_var_params = locals()
        all_params = ["key"]
        all_params.extend(
            [
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_sales_credit_notes_key_release" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `post_sales_credit_notes_key_release`"
            )
        collection_formats = {}
        path_params = {}
        if "key" in local_var_params:
    ...
    def put_sales_credit_notes_key(self, key, sales_credit_notes, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.put_sales_credit_notes_key_with_http_info(
            key, sales_credit_notes, **kwargs
        )

    def put_sales_credit_notes_key_with_http_info(
        self, key, sales_credit_notes, **kwargs
    ):
        local_var_params = locals()
        all_params = ["key", "sales_credit_notes"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_sales_credit_notes_key" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        if self.api_client.client_side_validation and (
