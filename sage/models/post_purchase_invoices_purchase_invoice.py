...
class PostPurchaseInvoicesPurchaseInvoice(object):
    """
    Attributes:
    ...
    openapi_types = {
        ...
        "invoice_lines": "list[PostPurchaseInvoicesPurchaseInvoiceInvoiceLines]",
    ...
    def due_date(self, due_date):
        if self.local_vars_configuration.client_side_validation and due_date is None:
    ...
    def __eq__(self, other):
        if not isinstance(other, PostPurchaseInvoicesPurchaseInvoice):
            return False
