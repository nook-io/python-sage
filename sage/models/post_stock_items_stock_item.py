...
class PostStockItemsStockItem(object):
    openapi_types = {
        "item_code": "str",
        "description": "str",
    ...
    def item_code(self, item_code):
        if self.local_vars_configuration.client_side_validation and item_code is None:
    ...
    def __eq__(self, other):
        if not isinstance(other, PostStockItemsStockItem):
            return False
