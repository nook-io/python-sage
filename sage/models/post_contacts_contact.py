...
class PostContactsContact(object):
    openapi_types = {
        "name": "str",
    ...
    def contact_type_ids(self, contact_type_ids):
        if (
            ...
            and contact_type_ids is None
        ):
            raise ValueError("Invalid value for `contact_type_ids`, must not be `None`")
    ...
    def __eq__(self, other):
        if not isinstance(other, PostContactsContact):
            return False
