...
import sage
from sage.models.put_purchase_credit_notes_purchase_credit_note import PutPurchaseCreditNotesPurchaseCreditNote  # noqa: E501
from sage.rest import ApiException

class TestPutPurchaseCreditNotesPurchaseCreditNote(unittest.TestCase):
    """PutPurchaseCreditNotesPurchaseCreditNote unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PutPurchaseCreditNotesPurchaseCreditNote
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = sage.models.put_purchase_credit_notes_purchase_credit_note.PutPurchaseCreditNotesPurchaseCreditNote()  # noqa: E501
        if include_optional :
            return PutPurchaseCreditNotesPurchaseCreditNote(
                contact_id = '0', 
                ...
                credit_note_lines = [
                    sage.models.put_purchase_credit_notes_purchase_credit_note_credit_note_lines.putPurchaseCreditNotes_purchase_credit_note_credit_note_lines(
                        description = '0', 
                        ledger_account_id = '0', 
                        quantity = 1.337, 
                        unit_price = 1.337, 
    ...
    def testPutPurchaseCreditNotesPurchaseCreditNote(self):
        """Test PutPurchaseCreditNotesPurchaseCreditNote"""
