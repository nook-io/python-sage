...
class UnallocatedArtefactsApi(object):
    ...
    def get_unallocated_artefacts(self, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_unallocated_artefacts_with_http_info(**kwargs)

    def get_unallocated_artefacts_with_http_info(self, **kwargs):
        local_var_params = locals()
        all_params = ["contact_id", "search", "attributes", "items_per_page", "page"]
        all_params.extend(
            [
                "async_req",
        ...
        if (
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_unallocated_artefacts`, must be a value less than or equal to `200`"
            )
        if (
            self.api_client.client_side_validation
            and "items_per_page" in local_var_params
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_unallocated_artefacts`, must be a value greater than or equal to `1`"
            )
        collection_formats = {}
        path_params = {}
        query_params = []
        ...
        return self.api_client.call_api(
            ...
            response_type="list[UnallocatedArtefact]",
    ...
    def get_unallocated_artefacts_key(self, key, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_unallocated_artefacts_key_with_http_info(key, **kwargs)

    def get_unallocated_artefacts_key_with_http_info(self, key, **kwargs):
        local_var_params = locals()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `get_unallocated_artefacts_key`"
            )
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="UnallocatedArtefact",
            auth_settings=auth_settings,
            async_req=local_var_params.get("async_req"),
            _return_http_data_only=local_var_params.get("_return_http_data_only"),
            _preload_content=local_var_params.get("_preload_content", True),
