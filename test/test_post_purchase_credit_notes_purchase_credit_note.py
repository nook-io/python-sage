...
import sage
from sage.models.post_purchase_credit_notes_purchase_credit_note import PostPurchaseCreditNotesPurchaseCreditNote  # noqa: E501
from sage.rest import ApiException

class TestPostPurchaseCreditNotesPurchaseCreditNote(unittest.TestCase):
    """PostPurchaseCreditNotesPurchaseCreditNote unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PostPurchaseCreditNotesPurchaseCreditNote
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = sage.models.post_purchase_credit_notes_purchase_credit_note.PostPurchaseCreditNotesPurchaseCreditNote()  # noqa: E501
        if include_optional :
            return PostPurchaseCreditNotesPurchaseCreditNote(
                contact_id = '0', 
                ...
                credit_note_lines = [
                    sage.models.post_purchase_credit_notes_purchase_credit_note_credit_note_lines.postPurchaseCreditNotes_purchase_credit_note_credit_note_lines(
                        description = '0', 
                        ledger_account_id = '0', 
                        quantity = 1.337, 
                        unit_price = 1.337, 
    ...
    def testPostPurchaseCreditNotesPurchaseCreditNote(self):
        """Test PostPurchaseCreditNotesPurchaseCreditNote"""
