...
import sage
from sage.models.purchase_invoice import PurchaseInvoice  # noqa: E501
...
class TestPurchaseInvoice(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = sage.models.purchase_invoice.PurchaseInvoice()  # noqa: E501
        if include_optional :
            return PurchaseInvoice(
                ...
                corrections = [
                    sage.models.purchase_corrective_invoice.PurchaseCorrectiveInvoice(
                        id = '0', 
                        displayed_as = '0', 
                        __path = '0', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
