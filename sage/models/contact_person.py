...
class ContactPerson(object):
    openapi_types = {
        ...
        "updated_at": "datetime",
        "deleted_at": "datetime",
        "contact_person_types": "list[ContactPersonType]",
        "name": "str",
        "job_title": "str",
        "telephone": "str",
        "mobile": "str",
    ...
    def __init__(
        ...
        self._contact_person_types = None
        self._name = None
        ...
        if contact_person_types is not None:
            self.contact_person_types = contact_person_types
        if name is not None:
            self.name = name
    ...
    @property
    def contact_person_types(self):
        return self._contact_person_types

    @contact_person_types.setter
    def contact_person_types(self, contact_person_types):
        self._contact_person_types = contact_person_types
