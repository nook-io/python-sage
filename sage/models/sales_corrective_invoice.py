...
class SalesCorrectiveInvoice(object):
    """
    Attributes:
    ...
    attribute_map = {
        ...
        "corrective_reason_code": "corrective_reason_code",
    ...
    def __init__(
        ...
        self._corrective_reason_code = None
        ...
        if corrective_reason_code is not None:
            self.corrective_reason_code = corrective_reason_code
    ...
    @property
    def corrective_reason_code(self):
        return self._corrective_reason_code

    @corrective_reason_code.setter
    def corrective_reason_code(self, corrective_reason_code):
        self._corrective_reason_code = corrective_reason_code

    @property
    def original_invoice(self):
        return self._original_invoice

    @original_invoice.setter
    def original_invoice(self, original_invoice):
        self._original_invoice = original_invoice
    ...
    def __eq__(self, other):
        if not isinstance(other, SalesCorrectiveInvoice):
            return False
