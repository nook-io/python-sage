...
class SalesQuickEntriesApi(object):
    def __init__(self, api_client=None):
        if api_client is None:
            api_client = ApiClient()
        self.api_client = api_client

    def delete_sales_quick_entries_key(self, key, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.delete_sales_quick_entries_key_with_http_info(key, **kwargs)

    def delete_sales_quick_entries_key_with_http_info(self, key, **kwargs):
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method delete_sales_quick_entries_key" % key
                )
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `delete_sales_quick_entries_key`"
            )
        collection_formats = {}
        path_params = {}
    ...
    def get_sales_quick_entries(self, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_sales_quick_entries_with_http_info(**kwargs)

    def get_sales_quick_entries_with_http_info(self, **kwargs):
        local_var_params = locals()
        all_params = [
            "contact_id",
            "search",
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_sales_quick_entries" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        if (
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_sales_quick_entries`, must be a value less than or equal to `200`"
            )
        if (
            self.api_client.client_side_validation
            and "items_per_page" in local_var_params
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_sales_quick_entries`, must be a value greater than or equal to `1`"
            )
        collection_formats = {}
        path_params = {}
        query_params = []
    ...
    def get_sales_quick_entries_key(self, key, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_sales_quick_entries_key_with_http_info(key, **kwargs)

    def get_sales_quick_entries_key_with_http_info(self, key, **kwargs):
        local_var_params = locals()
        all_params = [
            "key",
            "show_payments_allocations",
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_sales_quick_entries_key" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `get_sales_quick_entries_key`"
            )
        collection_formats = {}
        path_params = {}
        if "key" in local_var_params:
    ...
    def post_sales_quick_entries(self, sales_quick_entries, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.post_sales_quick_entries_with_http_info(
            sales_quick_entries, **kwargs
        )

    def post_sales_quick_entries_with_http_info(self, sales_quick_entries, **kwargs):
        local_var_params = locals()
        all_params = ["sales_quick_entries"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_sales_quick_entries" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        if self.api_client.client_side_validation and (
            "sales_quick_entries" not in local_var_params
            or local_var_params["sales_quick_entries"] is None
        ):
            raise ApiValueError(
                "Missing the required parameter `sales_quick_entries` when calling `post_sales_quick_entries`"
            )
        collection_formats = {}
        path_params = {}
        query_params = []
        ...
        local_var_files = {}
        body_params = None
        if "sales_quick_entries" in local_var_params:
            body_params = local_var_params["sales_quick_entries"]
        header_params["Accept"] = self.api_client.select_header_accept(
            ["application/json"]
        )
        if (
    ...
    def put_sales_quick_entries_key(self, key, sales_quick_entries, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.put_sales_quick_entries_key_with_http_info(
            key, sales_quick_entries, **kwargs
        )

    def put_sales_quick_entries_key_with_http_info(
        self, key, sales_quick_entries, **kwargs
    ):
        local_var_params = locals()
        all_params = ["key", "sales_quick_entries"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_sales_quick_entries_key" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `put_sales_quick_entries_key`"
            )
        if self.api_client.client_side_validation and (
            "sales_quick_entries" not in local_var_params
            or local_var_params["sales_quick_entries"] is None
            ...
            raise ApiValueError(
                "Missing the required parameter `sales_quick_entries` when calling `put_sales_quick_entries_key`"
            )
        collection_formats = {}
        path_params = {}
        if "key" in local_var_params:
