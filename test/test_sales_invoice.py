...
import sage
from sage.models.sales_invoice import SalesInvoice  # noqa: E501
...
class TestSalesInvoice(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = sage.models.sales_invoice.SalesInvoice()  # noqa: E501
        if include_optional :
            return SalesInvoice(
                id = '0', 
                displayed_as = '0', 
                ...
                transaction = sage.models.transaction.Transaction(
                    id = '0', 
                    displayed_as = '0', 
                    __path = '0', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                contact = sage.models.contact.Contact(
                    ...
                    cis_settings = sage.models.contact_cis_settings.ContactCisSettings(
                        ...
                        deduction_rate = sage.models.contact_cis_deduction_rate.ContactCisDeductionRate(
                            ...
                            displayed_as = '0', 
                            __path = '0', ), ), ), 
                recurring_invoice = sage.models.recurring_sales_invoice.RecurringSalesInvoice(
                    id = '0', 
                    displayed_as = '0', 
                    links = [
                        sage.models.link.Link(
                ...
                void_reason = '0', 
                invoice_lines = [
                    sage.models.sales_invoice_line_item.SalesInvoiceLineItem(
                        id = '0', 
                        displayed_as = '0', 
                        description = '0', 
                ...
                original_quote_estimate = sage.models.sales_invoice_quote_estimate.SalesInvoiceQuoteEstimate(
                    id = '0', 
                    displayed_as = '0', 
                    __path = '0', 
                    links = [
                ...
                corrections = [
                    sage.models.sales_corrective_invoice.SalesCorrectiveInvoice(
                        id = '0', 
                        displayed_as = '0', 
                        __path = '0', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        ...
                        withholding_tax_amount = 1.337, 
                        base_currency_withholding_tax_amount = 1.337, 
                        corrective_reason_code = sage.models.base.Base(
                            id = '0', 
                            displayed_as = '0', 
                            __path = '0', ), 
                        original_invoice = sage.models.generic.Generic(
                            id = '0', 
                            displayed_as = '0', 
                            __path = '0', ), 
