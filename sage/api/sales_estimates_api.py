...
class SalesEstimatesApi(object):
    ...
    def delete_sales_estimates_key(self, key, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.delete_sales_estimates_key_with_http_info(key, **kwargs)

    def delete_sales_estimates_key_with_http_info(self, key, **kwargs):
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `delete_sales_estimates_key`"
            )
        collection_formats = {}
        path_params = {}
    ...
    def get_sales_estimates(self, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_sales_estimates_with_http_info(**kwargs)

    def get_sales_estimates_with_http_info(self, **kwargs):
        local_var_params = locals()
        all_params = [
            "contact_id",
            "search",
        ...
        if (
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_sales_estimates`, must be a value less than or equal to `200`"
            )
        if (
            self.api_client.client_side_validation
            and "items_per_page" in local_var_params
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_sales_estimates`, must be a value greater than or equal to `1`"
            )
        collection_formats = {}
        path_params = {}
        query_params = []
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="list[SalesEstimate]",
            auth_settings=auth_settings,
            async_req=local_var_params.get("async_req"),
            _return_http_data_only=local_var_params.get("_return_http_data_only"),
            _preload_content=local_var_params.get("_preload_content", True),
    ...
    def get_sales_estimates_key(self, key, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_sales_estimates_key_with_http_info(key, **kwargs)

    def get_sales_estimates_key_with_http_info(self, key, **kwargs):
        local_var_params = locals()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `get_sales_estimates_key`"
            )
        collection_formats = {}
        path_params = {}
        if "key" in local_var_params:
    ...
    def post_sales_estimates(self, sales_estimates, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.post_sales_estimates_with_http_info(sales_estimates, **kwargs)

    def post_sales_estimates_with_http_info(self, sales_estimates, **kwargs):
        local_var_params = locals()
        all_params = ["sales_estimates"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        del local_var_params["kwargs"]
        if self.api_client.client_side_validation and (
            "sales_estimates" not in local_var_params
            or local_var_params["sales_estimates"] is None
        ):
            raise ApiValueError(
                "Missing the required parameter `sales_estimates` when calling `post_sales_estimates`"
            )
        collection_formats = {}
        path_params = {}
        query_params = []
    ...
    def put_sales_estimates_key(self, key, sales_estimates, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.put_sales_estimates_key_with_http_info(
            key, sales_estimates, **kwargs
        )

    def put_sales_estimates_key_with_http_info(self, key, sales_estimates, **kwargs):
        local_var_params = locals()
        all_params = ["key", "sales_estimates"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `put_sales_estimates_key`"
            )
        if self.api_client.client_side_validation and (
            "sales_estimates" not in local_var_params
            or local_var_params["sales_estimates"] is None
            ...
            raise ApiValueError(
                "Missing the required parameter `sales_estimates` when calling `put_sales_estimates_key`"
            )
        collection_formats = {}
        path_params = {}
        if "key" in local_var_params:
