...
class ArtefactStatusesApi(object):
    ...
    def get_artefact_statuses(self, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_artefact_statuses_with_http_info(**kwargs)

    def get_artefact_statuses_with_http_info(self, **kwargs):
        ...
        if (
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_artefact_statuses`, must be a value less than or equal to `200`"
            )
        if (
            self.api_client.client_side_validation
            and "items_per_page" in local_var_params
            ...
            raise ApiValueError(
                "Invalid value for parameter `items_per_page` when calling `get_artefact_statuses`, must be a value greater than or equal to `1`"
            )
        collection_formats = {}
        path_params = {}
        query_params = []
    ...
    def get_artefact_statuses_key(self, key, **kwargs):
        kwargs["_return_http_data_only"] = True
        return self.get_artefact_statuses_key_with_http_info(key, **kwargs)

    def get_artefact_statuses_key_with_http_info(self, key, **kwargs):
        local_var_params = locals()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `key` when calling `get_artefact_statuses_key`"
            )
        collection_formats = {}
        path_params = {}
