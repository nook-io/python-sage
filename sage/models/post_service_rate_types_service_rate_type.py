...
class PostServiceRateTypesServiceRateType(object):
    ...
    def active(self, active):
        if self.local_vars_configuration.client_side_validation and active is None:
    ...
    def __eq__(self, other):
        if not isinstance(other, PostServiceRateTypesServiceRateType):
            return False
