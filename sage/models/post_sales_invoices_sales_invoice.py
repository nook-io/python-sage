...
class PostSalesInvoicesSalesInvoice(object):
    """
    Attributes:
    ...
    openapi_types = {
        ...
        "invoice_lines": "list[PostSalesCreditNotesSalesCreditNoteCreditNoteLines]",
    ...
    def __eq__(self, other):
        if not isinstance(other, PostSalesInvoicesSalesInvoice):
            return False
