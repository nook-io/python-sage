...
import sage
from sage.models.sales_credit_note import SalesCreditNote  # noqa: E501
from sage.rest import ApiException

class TestSalesCreditNote(unittest.TestCase):
    """SalesCreditNote unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = sage.models.sales_credit_note.SalesCreditNote()  # noqa: E501
        if include_optional :
            return SalesCreditNote(
                ...
                contact = sage.models.contact.Contact(
                    ...
                    cis_settings = sage.models.contact_cis_settings.ContactCisSettings(
                        ...
                        deduction_rate = sage.models.contact_cis_deduction_rate.ContactCisDeductionRate(
                            ...
                            displayed_as = '0', 
                            __path = '0', ), ), ), 
                credit_note_number_prefix = '0', 
                credit_note_number = '0', 
                contact_name = '0', 
                contact_reference = '0', 
                date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                original_invoice_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                reference = '0', 
                ...
                void_reason = '0', 
                credit_note_lines = [
                    sage.models.sales_credit_note_line_item.SalesCreditNoteLineItem(
                        id = '0', 
                        displayed_as = '0', 
                        description = '0', 
