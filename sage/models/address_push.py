...
class AddressPush(object):
    ...
    def __init__(self, id=None, displayed_as=None, path=None, address_line_1=None, address_line_2=None, city=None, postal_code=None, country_id=None, deleted_at=None, created_at=None, updated_at=None, bank_account_id=None, contact_id=None, address_type_id=None, name=None, region=None, country_group_id=None, is_main_address=None, local_vars_configuration=None):  # noqa: E501
