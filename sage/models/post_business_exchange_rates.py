...
class PostBusinessExchangeRates(object):
    openapi_types = {
        "business_exchange_rate": "PostBusinessExchangeRatesBusinessExchangeRate"
    }
    ...
    def __eq__(self, other):
        if not isinstance(other, PostBusinessExchangeRates):
            return False
