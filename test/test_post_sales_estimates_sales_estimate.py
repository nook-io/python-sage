...
import sage
from sage.models.post_sales_estimates_sales_estimate import PostSalesEstimatesSalesEstimate  # noqa: E501
from sage.rest import ApiException

class TestPostSalesEstimatesSalesEstimate(unittest.TestCase):
    """PostSalesEstimatesSalesEstimate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PostSalesEstimatesSalesEstimate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = sage.models.post_sales_estimates_sales_estimate.PostSalesEstimatesSalesEstimate()  # noqa: E501
        if include_optional :
            return PostSalesEstimatesSalesEstimate(
                contact_id = '0', 
                ...
                delivery_address = sage.models.post_sales_corrective_invoices_sales_corrective_invoice_main_address.postSalesCorrectiveInvoices_sales_corrective_invoice_main_address(
                    ...
                    country_group_id = '0', ), 
                estimate_lines = [
                    sage.models.post_sales_estimates_sales_estimate_estimate_lines.postSalesEstimates_sales_estimate_estimate_lines(
                        description = '0', 
                        ledger_account_id = '0', 
                        quantity = 1.337, 
                        unit_price = 1.337, 
    ...
    def testPostSalesEstimatesSalesEstimate(self):
        """Test PostSalesEstimatesSalesEstimate"""
