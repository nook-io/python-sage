...
class PutContactOpeningBalances(object):
    openapi_types = {
        "contact_opening_balance": "PutContactOpeningBalancesContactOpeningBalance"
    }
    ...
    def __eq__(self, other):
        if not isinstance(other, PutContactOpeningBalances):
            return False
